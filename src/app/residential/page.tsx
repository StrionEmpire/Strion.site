...
export default function Residential(){
  return (
    <main style={wrap}>
      <h1 style={{fontSize:34,fontWeight:800}}>Residential Builds</h1>
      <p style={{color:"#cfcfcf",marginTop:8,lineHeight:1.7}}>
        Luxury custom builds for living spaces—dining & coffee tables, desks, wall pieces, and lighting. Designed to elevate daily life with purpose.
      </p>

      <section style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(260px,1fr))",gap:16,marginTop:16}}>
        {[
          {src:"/resonance-table.png",title:"Dining & Coffee"},
          {src:"/resonance-table.png",title:"Desks & Consoles"},
          {src:"/selenite-light.png",title:"Wall Pieces & Lighting"},
        ].map(x=>(
